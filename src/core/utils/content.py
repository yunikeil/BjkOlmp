...
Если я угадала, введите команду для установки клиента - {yellow}wget http://localhost:8000/inst{'{fext}'}{reset}
Если не угадала, введите эту - {yellow}wget http://localhost:8000/inst{'{_fext}'}{reset}
 -------------------------------------------------------------------------------
{bold}        \   ^__^
         \  (oo)\_______
            (__)\       )\/\
